...
import { EdustorytestimonialData } from "../../../Data/EduStoryTestimonial";

const EduStoryTestimonial = () => {
  ...
  return (
    <div className="w-full max-w-9xl mx-auto space-y-8 px-4 sm:px-6 lg:px-10 py-10">
      ...
      <Swiper
        ...
        className="w-full"
      >
        {EdustorytestimonialData.map((item) => (
...
export default EduStoryTestimonial;
