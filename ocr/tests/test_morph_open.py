import numpy as np
import pytest
from preprocessing_image.scripts.morph_open import preprocess
from preprocessing_image.validation.morph_open_validation import validate
...
@pytest.mark.sanity
def test_morph_open(test_image):
    params = {
        "ksize": 5,
    ...
    assert "removed_pixels" in result["metrics"]
...
@pytest.mark.sanity
def test_morph_open_default_params(test_image):
